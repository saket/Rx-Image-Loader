...
import me.saket.rxtest.data.SourceIdentifiableDrawable;
...
public class MainActivity extends AppCompatActivity {
    ...
    void onDownloadButtonClick() {
        ...
        mImageLoadSubscription = Observable.just(getSelectedImageUrl())
                ...
                .subscribe(new Subscriber<SourceIdentifiableDrawable>() {
                    @Override
                    public void onNext(SourceIdentifiableDrawable drawable) {
                        Log.d(TAG, "Image fetched from: " + drawable.getImageSource());
    ...
    @NonNull
    private Func1<String, Observable<SourceIdentifiableDrawable>> loadImageBitmapFromUrl() {
